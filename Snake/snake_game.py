# Code for snake game taken from: https://github.com/TheAILearner/Snake-Game-using-OpenCV-Python/blob/master/snake_game_using_opencv.ipynb
import numpy as np
import cv2
import random
import time
...
while True:
    ...
    cv2.rectangle(img, (apple_position[0], apple_position[1]),
                  (apple_position[0]+10, apple_position[1]+10), (0, 0, 255), 3)
    # Display Snake
    ...
    if collision_with_boundaries(snake_head) == 1 or collision_with_self(snake_position) == 1:
        ...
        img = np.zeros((500, 500, 3), dtype='uint8')
        cv2.putText(img, 'Your Score is {}'.format(score),
